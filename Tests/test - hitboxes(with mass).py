...
class Circles(object):
    def __init__(self, pos, density):
        ...
        self.rectHitbox = pygame.Rect(self.x - self.radius, self.y - self.radius,2*self.radius, 2*self.radius)
...
def collision(obj1, obj2):
    ...
    while obj1.rectHitbox.colliderect(obj2.rectHitbox):
...
circle1 = Circles((150,150), 0.4)
circle2 = Circles((320,120), 0.3)

rect1DisplayVel = textOnScreen(circle1.xVel, circle1.yVel, circle1.mass, (screenWidth//2, 10), 20, circle1.color)
rect2DisplayVel = textOnScreen(circle2.xVel, circle2.yVel, circle2.mass, (screenWidth//2, 60), 20, circle2.color)
...
while run :
    ...
    if circle1.rectHitbox.colliderect(circle2.rectHitbox):
